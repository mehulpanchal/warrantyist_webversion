...
<div class="row">
    <form class="form-horizontal" role="form" ng-submit="proccesadd()" name="addWarranty" id="addWarranty">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9" ng-controller="DatepickerCtrl">
                            ...
                            <p class="input-group">                               
                                <input type="text" class="form-control" datepicker-popup="{{ format }}" ng-model="frm.warranty_start_date" is-open="opened.openedStart" max-date="{{ frm.max_date}}" datepicker-options="dateOptions"  ng-required="true" close-text="Close" placeholder="Warranty start date" ng-keypress="13"/>                                                                                             
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="number" class="form-control input-inline input-medium" placeholder="Duration in Months" ng-model="frm.warranty_duration" name="warranty_duration" required>
                        </div>
                    </div>
                    <div class="form-group">
...
<!--                            <input type="text" class="form-control input-inline input-medium" placeholder="Invoice Date" ng-model="frm.invoice_date" name="invoice_date" required>-->               
        ...
        <div class="col-md-6 col-sm-12">   
            ...
            <div class="form-group">                    
                <div class="col-md-9">
                    <a ng-click="savewarranty_ser()" class="btn grey-cascade" ng-disabled="addWarranty.$invalid">Add Service Schedule</a> 
                </div>
            </div>
            <div class="form-group">                    
                <div class="col-md-9">
                    <a ng-click="savewarranty_amc()" class="btn grey-cascade" ng-disabled="addWarranty.$invalid">Add AMC</a> 
                </div>
            </div>               
            <div class="form-group">                    
                <div class="col-md-9">
