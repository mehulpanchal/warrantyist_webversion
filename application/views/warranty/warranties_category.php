...
<div class="row">
    <div class="col-sm-12">    
        <div class="portlet light tasks-widget">
            ...
            <div class="portlet box blue-madison" ng-if="warrantiescat !== 'E'"  ng-repeat="(k,v) in warrantiescat">
                <div class="portlet-title">
                    <div class="caption">
                        {{k}}
                    </div>
                        ...
                        <tbody>
                            <tr class="odd gradeX"  ng-repeat="pr in v">
                                ...
                                <td ng-if="pr.status == 'E'">
                                    ...
                                    {{ pr.product_name}} 
                                    <br />
                                    Expired on {{ pr.warranty_expiry_date | date:'dd, MMMM yyyy' }}
                                </td>
                                <td ng-if="pr.status == 'EX'">
                                    {{ pr.product_name}} 
                                    <br />
                                    Expires on {{ pr.warranty_expiry_date | date:'dd, MMMM yyyy' }}
                                </td>
                                <td ng-if="pr.status == 'A'">
                                    {{ pr.product_name}} 
                                    <br />
                                    Expiring on {{ pr.warranty_expiry_date | date:'dd, MMMM yyyy' }}
                                </td>
                                <td class="center">
