...
<div class="row">
    <form class="form-horizontal" role="form" ng-submit="proccesaddamc()" name="addAmc" id="addAmc">
        <div class="col-md-6 col-sm-12">
            <div class="portlet-body form">                                   
                <div class="form-body">
                    <div class="form-group">                    
                        <div class="col-md-9">                            
                            <select class="form-control" ng-model="frm.catid" ng-options="cat.cat_id as cat.cat_name for cat in category" required ng-if="!frm.cat_name">
                                <option value="">Category</option>                                              
                            </select>
                            <select class="form-control" ng-model="frm.catid" ng-options="cat.cat_id as cat.cat_name for cat in category"  ng-if="frm.cat_name">          
                                <option value="">{{ frm.cat_name }}</option>                                
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-9">
                            <input type="text" class="form-control input-inline input-medium" placeholder="Product Name" ng-model="frm.product_name" name="product_name" ng-required="true" ng-disabled="frm.cat_name" />
                        </div>
                    </div>
                    <div class="form-group">                    
                        <div class="col-md-9">
                            <input type="text" class="form-control input-inline input-medium" placeholder="Provider Name" ng-model="frm.amc_provider_name" name="amc_provider_name" required>
                        </div>
                    </div>
                    <div class="form-group">                    
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9" ng-controller="DatepickerCtrl">
                            ...
                            <p class="input-group">                               
                                <input type="text" class="form-control" datepicker-popup="{{ format }}" ng-model="frm.amc_start_date" is-open="opened.openedStart" max-date="{{ frm.max_date}}" datepicker-options="dateOptions"  ng-required="true" close-text="Close" placeholder="Start date"/>                                                                                             
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="number" class="form-control input-inline input-medium" placeholder="Duration in Months" ng-model="frm.duration" name="duration" required>
                        </div>
                    </div>
                </div>       
            </div>    
