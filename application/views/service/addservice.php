...
<div class="row">
    <form class="form-horizontal" role="form" ng-submit="proccesaddservice()" name="addService" id="addService">
        <div class="col-md-6 col-sm-12">
            <div class="portlet-body form">                                   
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-9">
                            <input type="text" class="form-control input-inline input-medium" placeholder="Product Name" ng-model="frm.product_name" name="product_name" ng-="true"required ng-disabled="frm.cat_name" />
                        </div>
                    </div>
                    <div class="form-group">                    
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9" ng-controller="DatepickerCtrl">
                            <p class="input-group" ng-repeat="frm in frm.items" ng-model="frm.items">                             
                                    <input type="text"  is-open="date_open"  ng-focus="date_open = true" datepicker-popup="{{ format}}"  ng-model="frm.start_date"  class="form-control" close-text="Close" placeholder="Start date" ng-model="frm.start_date" datepicker-options="dateOptions" />
